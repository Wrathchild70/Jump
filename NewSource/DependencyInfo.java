...
final class DependencyInfo {
  /** JavaElement that the requester depends upon. */
  JavaElement element;

  /** mode describing the way the JavaElement is needed. */
  int mode;

  DependencyInfo (JavaElement element, int mode)
  {
  ...
  {
    return "dependency upon " + element + " in mode " + mode;
  }
