...
public final class Long extends Number implements Comparable
{
  ...
  // modified for Jump by rk
  /**
   * The primitive type <code>long</code> is represented by this 
   * <code>Class</code> object.
   */
  public static final Class TYPE = getPrimitiveClass();

  /** Get the Class object of the 'long' datatype. */
  private static native Class getPrimitiveClass();
  ...
  // buggy implementation replaced by straightforward one by rk
  private static String toUnsignedString(long value, int bits) {
    long val = value;
    long mask = (1 << bits) - 1;
    StringBuffer bp = new StringBuffer(64 / bits + 1);
    do {
      bp.append(digits[(int)(val & mask)]);
      val >>>= bits;
    } while (val != 0);
  ...
  **/
  ...
  void appendTo(long l, StringBuffer s)
  {
    s.append( toString(l,10) );
  }
}
