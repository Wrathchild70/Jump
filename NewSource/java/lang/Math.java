...
public final class Math 
{
  ...
  /* 
   * no longer necessary, 
   * only for the native methods that no longer exist
  static {
  ...
  */
  ...
  static final double INV_2PI  = 0.5 / Math.PI;
  static final double INV_PI_2 = 2.0 / Math.PI;
  static final double INV_PI_4 = 4.0 / Math.PI;
  static final double PI_2     = 0.5 * Math.PI;
  static final double PI_4     = 0.25 * Math.PI;
  static final double PI3_4    = 0.75 * Math.PI;

  static final double S1 = -1.66666666666666324348e-01;
  static final double S2 =  8.33333333332248946124e-03;
  static final double S3 = -1.98412698298579493134e-04;
  static final double S4 =  2.75573137070700676789e-06;
  static final double S5 = -2.50507602534068634195e-08;
  static final double S6 =  1.58969099521155010221e-10;

  static final double C1 =  4.16666666666666019037e-02;
  static final double C2 = -1.38888888888741095749e-03;
  static final double C3 =  2.48015872894767294178e-05;
  static final double C4 = -2.75573143513906633035e-07;
  static final double C5 =  2.08757232129817482790e-09;
  static final double C6 = -1.13596475577881948265e-11;

  static final double  T1 =  3.33333333333334091986e-01;
  static final double  T2 =  1.33333333333201242699e-01;
  static final double  T3 =  5.39682539762260521377e-02;
  static final double  T4 =  2.18694882948595424599e-02;
  static final double  T5 =  8.86323982359930005737e-03;
  static final double  T6 =  3.59207910759131235356e-03;
  static final double  T7 =  1.45620945432529025516e-03;
  static final double  T8 =  5.88041240820264096874e-04;
  static final double  T9 =  2.46463134818469906812e-04;
  static final double T10 =  7.81794442939557092300e-05;
  static final double T11 =  7.14072491382608190305e-05;
  static final double T12 = -1.85586374855275456654e-05;
  static final double T13 =  2.59073051863633712884e-05;

  static final double pS0 =  1.66666666666666657415e-01;
  static final double pS1 = -3.25565818622400915405e-01;
  static final double pS2 =  2.01212532134862925881e-01;
  static final double pS3 = -4.00555345006794114027e-02;
  static final double pS4 =  7.91534994289814532176e-04;
  static final double pS5 =  3.47933107596021167570e-05;
  static final double qS1 = -2.40339491173441421878e+00;
  static final double qS2 =  2.02094576023350569471e+00;
  static final double qS3 = -6.88283971605453293030e-01;
  static final double qS4 =  7.70381505559019352791e-02;

  static final double AT0 =  3.33333333333329318027e-01;
  static final double AT1 = -1.99999999998764832476e-01;
  static final double AT2 =  1.42857142725034663711e-01;
  static final double AT3 = -1.11111104054623557880e-01;
  static final double AT4 =  9.09088713343650656196e-02;
  static final double AT5 = -7.69187620504482999495e-02;
  static final double AT6 =  6.66107313738753120669e-02;
  static final double AT7 = -5.83357013379057348645e-02;
  static final double AT8 =  4.97687799461593236017e-02;
  static final double AT9 = -3.65315727442169155270e-02;
  static final double AT10 =  1.62858201153657823623e-02;

  static final double ATAN_05 = 0.463647609000806093515;
  static final double ATAN_10 = 0.785398163397448278999;
  static final double ATAN_15 = 0.982793723247329054082;

  // 0.693147180369123816490 + 0.190821492927058770002e-09;
  static final double LN2     =  0.693147180559945309417; 
  static final double INV_LN2 =  1.44269504088896338700e+00;
  ...
  public static double sin(double x)
  {
    ...
    // general case: argument reduction needed
      ...
      ReducedArc reduced = new ReducedArc(x);
      switch (reduced.direction) {
      case 0: 
	return  kernelSin (reduced.value);
      case 1:
	return  kernelCos (reduced.value);
      case 2:
	return -kernelSin (reduced.value);
      default: 
	return -kernelCos (reduced.value);
  ...
  public static double tan(double x)
  {
    ...
    // general case: argument reduction needed
      ...
      case 0: 
      case 2:
	return  kernelTan (reduced.value);
      default: 
	return  -1.0 / kernelTan (reduced.value);
      }
    }
  }
  ...
  public static double acos(double x)
  {
    ...
    // -1.0 < x < -0.5
      ...
      return Math.PI - 2.0 * asin (sqrt (0.5 * (1.0 + x)));
    }
  }
  ...
  public static double log(double x)
  {
    ...
    double f = (Double.longBitsToDouble(Double.doubleToLongBits(x) - 
					(((long) k) << 52)) -
		1.0);
    double s = f / (2.0 + f);
    double z = s*s;
  ...
  public static double sqrt(double x)
  {
    ...
    double y = Double.longBitsToDouble (((long) (k - SQRT_PARMS[(k >> 15) & 31])) << 32);
  ...
  public static double pow(double x, double y)
  {
    ...
    if (x < 0.0) 
    {
      long lly = Double.doubleToLongBits(y);
      ...
      {
        long temp = ((((lly & 0x000fffffffffffffL) + 
          0x0010000000000000L) << expY) &
          0x001fffffffffffffL);
        if (temp == 0L) 
          yIntType = 2;
  ...
  public static double ceil(double x)
  {
	...
	if (ltrunc == lx) {
	  ...
	  return Double.longBitsToDouble(ltrunc) + 1.0;
	}
      }
    }
    else {
  ...
  public static double floor(double x)
  {
	...
	return Double.longBitsToDouble(lx & (0xffffffffffffffffL << (-exp)));
      }
    }
    else {
      if (exp < -52) {
  ...
  public static double rint(double x)
  {
	...
	if ((lx & (halfMask << 1)) != 0L) {
      ...
      return (Double.longBitsToDouble(lx & ~fractMask) + adder);
    }
  }
...
class ReducedArc {
  ...
  ReducedArc (double x) {
    long n = Math.round (Math.INV_PI_2 * x);
    direction = ((int) n) & 0x0003;
    value = x - n * Math.PI_2;
  }
}
