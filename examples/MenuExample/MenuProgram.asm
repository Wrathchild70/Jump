...
CharsToString:
	...
	move.w	#29,ObjectHeader_ClassIndex(a1)
...
CharPtr_to_String:
	...
	move.l	#26,d0	; Class	java/lang/String
	bsr	op_new
	move.l	(a7),-(a7)
	lea.l	DummyCharArray(a5),a0
	move.l	a0,-(a7)
...
getvoidptr:
	...
	cmp.w	#26,ObjectHeader_ClassIndex(a0)
...
cleanup_jumptable:
	rts
StaticObjectCount	equ	3
	code
; Method MenuProgram.PilotMain(III)I
M0:
	link	a6,#0
...
M0__stackOK
	tst.l	16(a6)
	bne	M0__7
	bsr	M1	; (direct)Method MenuProgram.run()V
M0__7:
	clr.l	d0
	unlk	a6
	rts
...
M1__stackOK
	pea	1004
	bsr	M59	; (direct)Method palmos/Palm.FrmGotoForm(I)V
	addq.l	#4,a7
	...
	move.l	(a7),-(a7)
	clr.l	-(a7)
	bsr	M70	; (direct)Method palmos/ShortHolder.<init>(S)V
	addq.l	#8,a7
	move.l	(a7)+,d6
M1__23:
	move.l	d7,a0
	...
	move.l	a0,-(a7)
	clr.l	-(a7)
	bsr	M53	; (direct)Method palmos/Palm.EvtGetEvent(Lpalmos/Event;I)V
	addq.l	#8,a7
	move.l	d7,-(a7)
	bsr	M68	; (direct)Method palmos/Palm.SysHandleEvent(Lpalmos/Event;)Z
	addq.l	#4,a7
	tst.l	d0
	bne	M1__23
	clr.l	-(a7)
	move.l	d7,-(a7)
	move.l	d6,-(a7)
	bsr	M67	; (direct)Method palmos/Palm.MenuHandleEvent(ILpalmos/Event;Lpalmos/ShortHolder;)Z
	lea	12(a7),a7
	tst.l	d0
	bne	M1__23
	move.l	d7,-(a7)
	bsr	M2	; (direct)Method MenuProgram.appHandleEvent(Lpalmos/Event;)Z
	addq.l	#4,a7
	tst.l	d0
	bne	M1__23
	move.l	d7,-(a7)
	bsr	M56	; (direct)Method palmos/Palm.FrmDispatchEvent(Lpalmos/Event;)Z
	addq.l	#4,a7
	bra	M1__23
M1__68:
	clr.l	d0
	...
	move.l	SF0(a5),-(a7)
	clr.l	-(a7)
	bsr	M63	; (direct)Method palmos/Palm.FrmSetEventHandler(ILpalmos/FormEventHandler;)V
	addq.l	#8,a7
	bsr	M55	; (direct)Method palmos/Palm.FrmCloseAllForms()V
	movem.l	-12(a6),d7-d6
	unlk	a6
	rts
M1__exceptions:
	...
	move.l	-4(a6),a1
	jmp	(a1)	; previous exception handler
; Method MenuProgram.appHandleEvent(Lpalmos/Event;)Z
M2:
	link	a6,#0
...
M2__stackOK
	...
	move.l	d0,d7
	move.l	d7,-(a7)
	bsr	M61	; (direct)Method palmos/Palm.FrmInitForm(I)I
	addq.l	#4,a7
	move.l	d0,SF0(a5)
	move.l	SF0(a5),-(a7)
	bsr	M62	; (direct)Method palmos/Palm.FrmSetActiveForm(I)V
	addq.l	#4,a7
	cmp.l	#1004,d7
	bne	M2__47
	move.l	#24,d0	; Class MenuProgram$Form1Handler
	bsr     op_new
	move.l	(a7),-(a7)
	bsr	M81	; (direct)Method MenuProgram$Form1Handler.<init>()V
	addq.l	#4,a7
	move.l	(a7)+,SOF0(a5)
	bra	M2__69
M2__47:
	cmp.l	#1026,d7
	bne	M2__67
	move.l	#25,d0	; Class MenuProgram$Form2Handler
	bsr     op_new
	move.l	(a7),-(a7)
	bsr	M84	; (direct)Method MenuProgram$Form2Handler.<init>()V
	addq.l	#4,a7
	move.l	(a7)+,SOF0(a5)
	bra	M2__69
M2__67:
...
M13__stackOK
	move.l	8(a6),-(a7)
	bsr	M5	; (direct)Method java/lang/Object.getClass()Ljava/lang/Class;
	move.l	a0,(a7)
	move.l	(a7),a0
	bsr     nonnull_check
	bsr	M20	; (direct)Method java/lang/Class.getName()Ljava/lang/String;
	addq.l	#4,a7
...
M13__17:
	...
	bsr     op_new
	move.l	(a7),-(a7)
	bsr	M30	; (direct)Method java/lang/StringBuffer.<init>()V
	move.l	d7,(a7)
	bsr	M35	; (direct)Method java/lang/StringBuffer.append(Ljava/lang/String;)Ljava/lang/StringBuffer;
	addq.l	#8,a7
	move.l	a0,-(a7)
	pea	CS0(a5)	; ": "
	move.l	4(a7),a0
	...
	move.l	(a7),a0
	bsr     nonnull_check
	bsr	M41	; (direct)Method java/lang/StringBuffer.toString()Ljava/lang/String;
	move.l	-8(a6),d7
	unlk	a6
	rts
M13__exceptions:
...
M14__stackOK
	...
	beq	M14__11
	move.l	8(a6),-(a7)
	bsr	M16	; (direct)Method java/lang/Throwable.getMethodName(I)Ljava/lang/String;
	move.l	a0,(a7)
	bsr	M109	; (direct)Method palmos/JumpLog.println(Ljava/lang/String;)V
	addq.l	#4,a7
M14__11:
	unlk	a6
	rts
...
M15__stackOK
	...
	move.l	a0,-(a7)
	move.l	d7,-(a7)
	bsr	M13	; (direct)Method java/lang/Throwable.toString()Ljava/lang/String;
	move.l	a0,(a7)
	move.l	4(a7),a0
	bsr     nonnull_check
	bsr	M35	; (direct)Method java/lang/StringBuffer.append(Ljava/lang/String;)Ljava/lang/StringBuffer;
	...
	move.l	d7,a0
	move.l	4(a0),-(a7)
	bsr	M14	; (direct)Method java/lang/Throwable.printMethod(I)V
	addq.l	#4,a7
	move.l	d7,a0
	move.l	8(a0),-(a7)
	bsr	M14	; (direct)Method java/lang/Throwable.printMethod(I)V
...
M18__stackOK
	move.l	12(a6),-(a7)
	move.l	8(a6),-(a7)
	bsr	M12	; (direct)Method java/lang/Throwable.<init>(Ljava/lang/String;)V
	unlk	a6
	rts
M18__exceptions:
	move.l	4(a6),d2
...
M25__stackOK
	...
	move.l	(a7),-(a7)
	move.l	8(a6),-(a7)
	bsr	M22	; (direct)Method java/lang/Class.isInterface()Z
	addq.l	#4,a7
	tst.l	d0
	beq	M25__16
...
M25__16:
	move.l	8(a6),-(a7)
	bsr	M23	; (direct)Method java/lang/Class.isPrimitive()Z
	addq.l	#4,a7
	tst.l	d0
	beq	M25__28
	pea	CS4(a5)	; ""
...
M25__28:
	pea	CS5(a5)	; "class "
M25__30:
	bsr	M92	; (direct)Method java/lang/String.valueOf(Ljava/lang/Object;)Ljava/lang/String;
	move.l	a0,(a7)
	bsr	M32	; (direct)Method java/lang/StringBuffer.<init>(Ljava/lang/String;)V
	addq.l	#8,a7
	move.l	8(a6),-(a7)
	bsr	M20	; (direct)Method java/lang/Class.getName()Ljava/lang/String;
	move.l	a0,(a7)
...
M26__stackOK
	...
	move.l	8(a6),-(a7)
	bsr     op_idiv
	bsr	M31	; (direct)Method java/lang/StringBuffer.<init>(I)V
	addq.l	#8,a7
	move.l	(a7)+,d7
M26__12:
	move.l	d7,-(a7)
	...
	move.b	(a1),d0
	move.l	d0,-(a7)
	bsr	M33	; (direct)Method java/lang/StringBuffer.append(C)Ljava/lang/StringBuffer;
	addq.l	#8,a7
	move.l	a0,d0
	move.l	d6,d0
	move.l	8(a6),d1
	...
	bne	M26__12
	move.l	d7,-(a7)
	bsr	M40	; (direct)Method java/lang/StringBuffer.reverse()Ljava/lang/StringBuffer;
	move.l	a0,(a7)
	move.l	(a7),a0
	bsr     nonnull_check
	bsr	M41	; (direct)Method java/lang/StringBuffer.toString()Ljava/lang/String;
...
M27__stackOK
	move.l	8(a6),-(a7)
	pea	4
	bsr	M26	; (direct)Method java/lang/Integer.toUnsignedString(II)Ljava/lang/String;
	unlk	a6
	rts
M27__exceptions:
	move.l	4(a6),d2
...
M33__stackOK
	...
	move.l	d7,-(a7)
	move.l	d6,-(a7)
	bsr	M37	; (direct)Method java/lang/StringBuffer.expandCapacity(I)V
	addq.l	#8,a7
M33__21:
	move.l	d7,a0
	move.l	(a0),-(a7)
...
M34__stackOK
	move.l	12(a6),-(a7)
	move.l	8(a6),-(a7)
	bsr	M93	; (direct)Method java/lang/String.valueOf(I)Ljava/lang/String;
	move.l	a0,(a7)
	bsr	M35	; (direct)Method java/lang/StringBuffer.append(Ljava/lang/String;)Ljava/lang/StringBuffer;
	unlk	a6
	rts
...
M35__35:
	...
	move.l	(a0),-(a7)
	move.l	4(a0),-(a7)
	bsr	M90	; (direct)Method java/lang/String.getChars(II[CI)V
	move.l	d7,a0
	move.l	d6,4(a0)
	movem.l	-20(a6),d7-d4
	unlk	a6
...
M36__stackOK
	...
	clr.l	-(a7)
	move.l	4(a0),-(a7)
	bsr	M98	; (direct)Method java/lang/System.arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
	lea	20(a7),a7
	move.l	d6,d0
	move.l	d7,a0
	move.l	d0,(a0)
...
M38__stackOK
	...
	blt	M38__21
M38__12:
	move.l	#35,d0	; Class java/lang/StringIndexOutOfBoundsException
	bsr     op_new
	move.l	(a7),-(a7)
	move.l	d7,-(a7)
	bsr	M105	; (direct)Method java/lang/StringIndexOutOfBoundsException.<init>(I)V
	addq.l	#8,a7
	bsr     op_athrow
M38__21:
	tst.l	d6
...
M38__64:
	...
	bsr	M106	; (direct)Method java/lang/StringIndexOutOfBoundsException.<init>(Ljava/lang/String;)V
	addq.l	#8,a7
	bsr     op_athrow
M38__79:
	movem.l	-12(a6),d7-d6
...
M40__stackOK
	...
	beq	M40__11
	move.l	a0,-(a7)
	bsr	M36	; (direct)Method java/lang/StringBuffer.copy()V
	addq.l	#4,a7
M40__11:
	move.l	d6,a0
	move.l	4(a0),d0
...
M41__stackOK
	...
	move.l	(a7),-(a7)
	move.l	8(a6),-(a7)
	bsr	M86	; (direct)Method java/lang/String.<init>(Ljava/lang/StringBuffer;)V
	addq.l	#8,a7
	move.l	(a7)+,a0
	unlk	a6
	rts
...
frmcallbackvector
	...
	addq.l  #8,a7
	rts
; Method palmos/FormEventHandler.dispatch(Lpalmos/Event;)Z
M76:
	link	a6,#0
...
M76__stackOK
	...
	clr.l	d0
	move.w	0(a0),d0
	jsr	0(a1,d0.l)	; ...Method palmos/FormEventHandler.callback(Lpalmos/Event;)Z
	unlk	a6
	rts
M76__exceptions:
	move.l	4(a6),d2
	...
	move.l	-4(a6),a1
	jmp	(a1)	; previous exception handler
; Method palmos/FormEventHandler.callback(Lpalmos/Event;)Z
M77:
	link	a6,#0
...
M80__stackOK
	move.l	12(a6),-(a7)
	move.l	8(a6),-(a7)
	bsr	M18	; (direct)Method java/lang/Exception.<init>(Ljava/lang/String;)V
	unlk	a6
	rts
M80__exceptions:
	move.l	4(a6),d2
	...
	move.l	-4(a6),a1
	jmp	(a1)	; previous exception handler
; Method MenuProgram$Form1Handler.<init>()V
M81:
	link	a6,#0
...
M81__stackOK
	move.l	8(a6),-(a7)
	bsr	M75	; (direct)Method palmos/FormEventHandler.<init>()V
	unlk	a6
	rts
M81__exceptions:
	move.l	4(a6),d2
	...
	move.l	-4(a6),a1
	jmp	(a1)	; previous exception handler
; Method MenuProgram$Form1Handler.callback(Lpalmos/Event;)Z
M82:
	link	a6,#0
	pea	M82__exceptions(pc)
	move.l	d7,-(a7)
...
M82__stackOK
	...
	bne	M82__18
	move.l	SF0(a5),-(a7)
	bsr	M57	; (direct)Method palmos/Palm.FrmDrawForm(I)V
	addq.l	#4,a7
	bra	M82__80
M82__18:
	move.l	d7,a0
	...
	move.l	12(a6),-(a7)
	move.l	a0,-(a7)
	bsr	M83	; (direct)Method MenuProgram$Form1Handler.menuMainEvent(Lpalmos/Event;)Z
	addq.l	#8,a7
	bra	M82__80
M82__36:
	move.l	d7,a0
...
M82__64:
	move.l	SF0(a5),-(a7)
	move.l	d7,-(a7)
	bsr	M60	; (direct)Method palmos/Palm.FrmHandleEvent(ILpalmos/Event;)Z
	move.l	-8(a6),d7
	unlk	a6
	rts
M82__72:
...
M82__exceptions:
	...
	move.l	-4(a6),a1
	jmp	(a1)	; previous exception handler
; Method MenuProgram$Form1Handler.menuMainEvent(Lpalmos/Event;)Z
M83:
	link	a6,#0
...
M83__20:
	...
	bne	M83__36
	pea	1063
	bsr	M54	; (direct)Method palmos/Palm.FrmAlert(I)I
	move.l	#1,d0
	move.l	-8(a6),d7
	unlk	a6
	rts
...
M83__exceptions:
	...
	move.l	-4(a6),a1
	jmp	(a1)	; previous exception handler
; Method MenuProgram$Form2Handler.<init>()V
M84:
	link	a6,#0
	pea	M84__exceptions(pc)
	cmp.l	StackLimit(a5),a7
	bcc.s	M84__stackOK
	bsr     throw_StackOverflowError
M84__stackOK
...
M84__exceptions:
	...
	move.l	-4(a6),a1
	jmp	(a1)	; previous exception handler
; Method MenuProgram$Form2Handler.callback(Lpalmos/Event;)Z
M85:
	link	a6,#0
...
M85__stackOK
	...
	bne	M85__21
	pea	1026
	bsr	M58	; (direct)Method palmos/Palm.FrmGetFormPtr(I)I
	move.l	d0,(a7)
	bsr	M57	; (direct)Method palmos/Palm.FrmDrawForm(I)V
	addq.l	#4,a7
	bra	M85__57
...
M86__stackOK
	...
	move.l	(a0),-(a7)
	clr.l	-(a7)
	bsr	M38	; (direct)Method java/lang/StringBuffer.getChars(II[CI)V
	lea	20(a7),a7
M86__43:
	move.l	-8(a6),d7
	unlk	a6
...
M94__stackOK
	pea	CS8(a5)	; "float"
	bsr	M21	; (direct)Method java/lang/Class.getPrimitiveClass(Ljava/lang/String;)Ljava/lang/Class;
	addq.l	#4,a7
	move.l	a0,d0
	unlk	a6
	rts
...
M103__stackOK
	move.l	12(a6),-(a7)
	move.l	8(a6),-(a7)
	bsr	M80	; (direct)Method java/lang/RuntimeException.<init>(Ljava/lang/String;)V
	unlk	a6
	rts
M103__exceptions:
	move.l	4(a6),d2
...
M105__stackOK
	...
	addq.l	#8,a7
	move.l	8(a6),-(a7)
	bsr	M34	; (direct)Method java/lang/StringBuffer.append(I)Ljava/lang/StringBuffer;
	addq.l	#8,a7
	move.l	a0,-(a7)
	move.l	(a7),a0
	bsr     nonnull_check
	bsr	M41	; (direct)Method java/lang/StringBuffer.toString()Ljava/lang/String;
	move.l	a0,(a7)
	bsr	M103	; (direct)Method java/lang/IndexOutOfBoundsException.<init>(Ljava/lang/String;)V
	unlk	a6
	rts
M105__exceptions:
	move.l	4(a6),d2
...
M107__stackOK
	...
	move.l	16(a6),-(a7)
	move.l	d3,-(a7)
	bsr	M49	; (direct)Method palmos/Palm.DmQueryRecord(II)I
	addq.l	#8,a7
	move.l	d0,d7
	; avoided 	tst.l	d7
	beq	M107__183
	move.l	d7,-(a7)
	bsr	M64	; (direct)Method palmos/Palm.MemHandleLock(I)I
	addq.l	#4,a7
	move.l	d0,d6
	move.l	d6,-(a7)
	bsr	M42	; (direct)Method palmos/Palm.nativeGetInt(I)I
	addq.l	#4,a7
	cmp.l	#1249209712,d0
	bne	M107__177
	move.l	d6,d0
	...
	add.l	#8,d0
	move.l	d0,-(a7)
	bsr	M43	; (direct)Method palmos/Palm.nativeGetByte(I)I
	addq.l	#4,a7
	cmp.l	#10,d0
	bne	M107__177
	move.l	d7,-(a7)
	bsr	M65	; (direct)Method palmos/Palm.MemHandleSize(I)I
	addq.l	#4,a7
	sub.l	#1,d0
	move.l	d0,d5
	move.b	SF3(a5),d0
...
M107__88:
	...
	move.l	d0,-28(a6)
	move.l	d7,-(a7)
	bsr	M66	; (direct)Method palmos/Palm.MemHandleUnlock(I)I
	move.l	16(a6),(a7)
	move.l	d3,-(a7)
	move.l	-28(a6),-(a7)
	bsr	M51	; (direct)Method palmos/Palm.DmResizeRecord(III)I
	lea	12(a7),a7
	move.l	d0,-32(a6)
	move.l	16(a6),-(a7)
	move.l	d3,-(a7)
	bsr	M45	; (direct)Method palmos/Palm.DmGetRecord(II)I
	addq.l	#8,a7
	move.l	d0,d7
	move.l	d7,-(a7)
	bsr	M64	; (direct)Method palmos/Palm.MemHandleLock(I)I
	...
	move.l	8(a6),-(a7)
	move.l	d4,-(a7)
	bsr	M52	; (direct)Method palmos/Palm.DmWrite(IILjava/lang/Object;I)I
	lea	16(a7),a7
	move.l	d6,-(a7)
	move.l	d5,d0
	add.l	d4,d0
	...
	move.l	d3,-(a7)
	pea	1
	bsr	M50	; (direct)Method palmos/Palm.DmReleaseRecord(IIZ)I
	lea	12(a7),a7
	move.l	-28(a6),d0
	sub.l	#1,d0
	move.l	d0,d5
...
M109__stackOK
	move.l	SF2(a5),d7
	; avoided 	tst.l	SF2(a5)
	bne	M109__19
	move.l	#1145132097,-(a7)
	move.l	#1835363695,-(a7)
	pea	3
	bsr	M48	; (direct)Method palmos/Palm.DmOpenDatabaseByTypeCreator(III)I
	lea	12(a7),a7
	move.l	d0,d7
M109__19:
	tst.l	d7
	...
	move.l	SF1(a5),-(a7)
	move.l	d3,-(a7)
	bsr	M107	; (direct)Method palmos/JumpLog.writeRecord(IILjava/lang/String;)Z
	lea	12(a7),a7
	tst.l	d0
	bne	M109__132
	move.l	d7,-(a7)
	bsr	M47	; (direct)Method palmos/Palm.DmNumRecords(I)I
	addq.l	#4,a7
	move.l	d0,-28(a6)
	move.l	-28(a6),d6
M109__41:
...
M109__60:
	...
	bsr     op_new
	move.l	(a7),-(a7)
	bsr	M69	; (direct)Method palmos/ShortHolder.<init>()V
	addq.l	#4,a7
	move.l	(a7)+,d4
	move.l	d7,-(a7)
	move.l	d4,-(a7)
	pea	10
	bsr	M46	; (direct)Method palmos/Palm.DmNewRecord(ILpalmos/ShortHolder;I)I
	lea	12(a7),a7
	move.l	d0,d5
	; avoided 	tst.l	d5
	beq	M109__132
...
M109__132:
	...
	bne	M109__143
	move.l	d7,-(a7)
	bsr	M44	; (direct)Method palmos/Palm.DmCloseDatabase(I)I
	addq.l	#4,a7
M109__143:
	move.l	d3,-(a7)
	bsr	M108	; (direct)Method palmos/JumpLog.reporter(Ljava/lang/String;)V
	movem.l	-24(a6),d7-d3
	unlk	a6
	rts
M109__exceptions:
...
ClassTable:
	...
	dc.b	0,0
	dc.w	M30	; def constructor
	dc.w	class14__name
	dc.l	class14__vtable-2
	dc.w	0,0,0,0		; no itable index
	dc.w	1		; ObjectHeader_ClassIndex: java/lang/Class
	dc.w	0	; java/lang/Object
	dc.w	ObjectHeader_sizeof+0
	...
	dc.b	0,0
	dc.w	M69	; def constructor
	dc.w	class16__name
	dc.l	class16__vtable-2
	dc.w	0,0,0,0		; no itable index
	dc.w	1		; ObjectHeader_ClassIndex: java/lang/Class
	dc.w	-1	; (no superclass)
	dc.w	ObjectHeader_sizeof+0
	...
	dc.w	ObjectHeader_sizeof+10
	dc.b	0,0
	dc.w	M75	; def constructor
	dc.w	class21__name
	dc.l	class21__vtable-0
	dc.w	0,0,0,0		; no itable index
	dc.w	1		; ObjectHeader_ClassIndex: java/lang/Class
	dc.w	23	; java/lang/RuntimeException
	dc.w	ObjectHeader_sizeof+36
	dc.b	0,0
	dc.w	M_none	; def constructor
	dc.w	class22__name
	dc.l	class22__vtable-2
	dc.w	0,0,0,0		; no itable index
	dc.w	1		; ObjectHeader_ClassIndex: java/lang/Class
	...
	dc.w	0,0,0,0		; no itable index
	dc.w	1		; ObjectHeader_ClassIndex: java/lang/Class
	dc.w	21	; palmos/FormEventHandler
	dc.w	ObjectHeader_sizeof+10
	dc.b	0,0
	dc.w	M81	; def constructor
	dc.w	class24__name
	...
	dc.w	ObjectHeader_sizeof+10
	dc.b	0,0
	dc.w	M84	; def constructor
	dc.w	class25__name
	dc.l	class25__vtable-0
	dc.w	0,0,0,0		; no itable index
	dc.w	1		; ObjectHeader_ClassIndex: java/lang/Class
	dc.w	0	; java/lang/Object
	...
	dc.w	M_none	; def constructor
	dc.w	class32__name
	dc.l	class32__vtable-2
	dc.w	0,0,0,0		; no itable index
	dc.w	1		; ObjectHeader_ClassIndex: java/lang/Class
	dc.w	34	; java/lang/IndexOutOfBoundsException
	dc.w	ObjectHeader_sizeof+36
	dc.b	0,0
	dc.w	M_none	; def constructor
	dc.w	class33__name
	dc.l	class33__vtable-2
	dc.w	0,0,0,0		; no itable index
	dc.w	1		; ObjectHeader_ClassIndex: java/lang/Class
	dc.w	23	; java/lang/RuntimeException
	dc.w	ObjectHeader_sizeof+36
...
class1__name	dc.b	'java.lang.Class',0
	align	2
class1__vtable:
	dc.w	M25	; Method java/lang/Class.toString()Ljava/lang/String;
class2__name	dc.b	'MenuProgram',0
	align	2
class3__name	dc.b	'java.lang.OutOfMemoryError',0
	align	2
class3__vtable:
	dc.w	M13	; Method java/lang/Throwable.toString()Ljava/lang/String;
...
class14__name	dc.b	'java.lang.StringBuffer',0
	align	2
class14__vtable:
	dc.w	M41	; Method java/lang/StringBuffer.toString()Ljava/lang/String;
class15__name	dc.b	'palmos.Palm',0
	align	2
class16__name	dc.b	'palmos.ShortHolder',0
	align	2
class16__vtable:
	dc.w	M7	; Method java/lang/Object.toString()Ljava/lang/String;
...
class20__name	dc.b	'-Z-',0
	align	2
class21__name	dc.b	'palmos.FormEventHandler',0
	align	2
class21__vtable:
	dc.w	M77	; Method palmos/FormEventHandler.callback(Lpalmos/Event;)Z
	dc.w	M7	; Method java/lang/Object.toString()Ljava/lang/String;
class22__name	dc.b	'java.lang.NullPointerException',0
	align	2
class22__vtable:
	dc.w	M13	; Method java/lang/Throwable.toString()Ljava/lang/String;
class23__name	dc.b	'java.lang.RuntimeException',0
	align	2
class24__name	dc.b	'MenuProgram$Form1Handler',0
	align	2
class24__vtable:
	dc.w	M82	; Method MenuProgram$Form1Handler.callback(Lpalmos/Event;)Z
	dc.w	M7	; Method java/lang/Object.toString()Ljava/lang/String;
class25__name	dc.b	'MenuProgram$Form2Handler',0
	align	2
class25__vtable:
	dc.w	M85	; Method MenuProgram$Form2Handler.callback(Lpalmos/Event;)Z
	dc.w	M7	; Method java/lang/Object.toString()Ljava/lang/String;
class26__name	dc.b	'java.lang.String',0
	align	2
class26__vtable:
	dc.w	M88	; Method java/lang/String.toString()Ljava/lang/String;
class27__name	dc.b	'java.lang.Float',0
	align	2
class28__name	dc.b	'java.lang.Double',0
	align	2
class29__name	dc.b	'[C',0
	align	2
class29__vtable:
	dc.w	M7	; Method java/lang/Object.toString()Ljava/lang/String;
class30__name	dc.b	'java.lang.NegativeArraySizeException',0
	align	2
class30__vtable:
	dc.w	M13	; Method java/lang/Throwable.toString()Ljava/lang/String;
class31__name	dc.b	'java.lang.System',0
	align	2
class32__name	dc.b	'java.lang.ArithmeticException',0
	align	2
class32__vtable:
	dc.w	M13	; Method java/lang/Throwable.toString()Ljava/lang/String;
class33__name	dc.b	'java.lang.ArrayIndexOutOfBoundsException',0
	align	2
class33__vtable:
	dc.w	M13	; Method java/lang/Throwable.toString()Ljava/lang/String;
class34__name	dc.b	'java.lang.IndexOutOfBoundsException',0
	align	2
class35__name	dc.b	'java.lang.StringIndexOutOfBoundsException',0
	align	2
class35__vtable:
	dc.w	M13	; Method java/lang/Throwable.toString()Ljava/lang/String;
class36__name	dc.b	'palmos.JumpLog',0
	align	2
class37__name	dc.b	'java.lang.ArrayStoreException',0
	align	2
class37__vtable:
	dc.w	M13	; Method java/lang/Throwable.toString()Ljava/lang/String;
...
SOF0	ds.l	1	; MenuProgram.feh
SOF1	ds.l	1	; java/lang/Integer.digits
SF3	ds.b	1	; palmos/JumpLog.appendNext
SF4	ds.b	1	; palmos/JumpLog.traceInitialized
	align	2
SF0	ds.l	1	; MenuProgram.form
SF1	ds.l	1	; palmos/JumpLog.recNum
SF2	ds.l	1	; palmos/JumpLog.memoHandle
