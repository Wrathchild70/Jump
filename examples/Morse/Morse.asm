...
CharsToString:
	...
	move.w	#35,ObjectHeader_ClassIndex(a1)
...
CharPtr_to_String:
	...
	move.l	#18,d0	; Class	java/lang/String
	bsr	op_new
	move.l	(a7),-(a7)
	lea.l	DummyCharArray(a5),a0
	move.l	a0,-(a7)
...
getvoidptr:
	...
	cmp.w	#18,ObjectHeader_ClassIndex(a0)
...
M0__stackOK
	move.l	#17,d0	; Class MorseProducer
	bsr     op_new
	move.l	(a7),-(a7)
	bsr	M47	; (direct)Method MorseProducer.<init>()V
	addq.l	#4,a7
	move.l	(a7)+,d0
	move.l	d7,a0
	move.l	d0,4(a0)
	move.l	#27,d0	; Class palmos/SndCommand
	bsr     op_new
	move.l	(a7)+,d0
	move.l	d7,a0
	move.l	d0,8(a0)
...
M1__stackOK
	tst.l	16(a6)
	bne	M1__14
	move.l	#2,d0	; Class Morse
	bsr     op_new
	move.l	(a7),-(a7)
	bsr	M0	; (direct)Method Morse.<init>()V
	addq.l	#4,a7
	bsr	M2	; (direct)Method Morse.run()V
	addq.l	#4,a7
M1__14:
	clr.l	d0
	unlk	a6
...
M2__stackOK
	clr.l	d0
	pea	1000
	bsr	M90	; (direct)Method palmos/Palm.FrmGotoForm(I)V
	addq.l	#4,a7
	move.l	#30,d0	; Class palmos/Event
	bsr     op_new
	move.l	(a7)+,d7
	move.l	#29,d0	; Class palmos/ShortHolder
	bsr     op_new
	move.l	(a7),-(a7)
	clr.l	-(a7)
	bsr	M102	; (direct)Method palmos/ShortHolder.<init>(S)V
	addq.l	#8,a7
	move.l	(a7)+,-28(a6)
M2__28:
	move.l	d7,a0
	...
	move.l	(a7),a0
	bsr     nonnull_check
	bsr	M50	; (direct)Method MorseProducer.getNextTick()I
	addq.l	#4,a7
	move.l	d0,d4
	bsr	M100	; (direct)Method palmos/Palm.TimGetTicks()I
	move.l	d0,d5
	move.l	d5,d0
	cmp.l	d4,d0
	blt	M2__95
	...
	move.l	4(a7),a0
	bsr     nonnull_check
	bsr	M51	; (direct)Method MorseProducer.playNow(I)I
	addq.l	#8,a7
	move.l	d0,-(a7)
	bsr	M4	; (direct)Method Morse.playSound(I)V
	addq.l	#8,a7
	move.l	d6,a0
	move.l	4(a0),-(a7)
	move.l	(a7),a0
...
M2__106:
	move.l	d7,-(a7)
	move.l	d3,-(a7)
	bsr	M82	; (direct)Method palmos/Palm.EvtGetEvent(Lpalmos/Event;I)V
	addq.l	#8,a7
	move.l	d7,-(a7)
	bsr	M99	; (direct)Method palmos/Palm.SysHandleEvent(Lpalmos/Event;)Z
	addq.l	#4,a7
	tst.l	d0
	bne	M2__28
	clr.l	-(a7)
	move.l	d7,-(a7)
	move.l	-28(a6),-(a7)
	bsr	M97	; (direct)Method palmos/Palm.MenuHandleEvent(ILpalmos/Event;Lpalmos/ShortHolder;)Z
	lea	12(a7),a7
	tst.l	d0
	bne	M2__28
	move.l	d6,-(a7)
	move.l	d7,-(a7)
	bsr	M3	; (direct)Method Morse.appHandleEvent(Lpalmos/Event;)Z
	addq.l	#8,a7
	tst.l	d0
	bne	M2__28
	bsr	M87	; (direct)Method palmos/Palm.FrmGetActiveForm()I
	move.l	d0,-(a7)
	move.l	d7,-(a7)
	bsr	M91	; (direct)Method palmos/Palm.FrmHandleEvent(ILpalmos/Event;)Z
	addq.l	#8,a7
	bra	M2__28
M2__146:
	bsr	M85	; (direct)Method palmos/Palm.FrmCloseAllForms()V
	movem.l	-24(a6),d7-d3
	unlk	a6
	rts
M2__exceptions:
	...
	move.l	-4(a6),a1
	jmp	(a1)	; previous exception handler
; Method Morse.appHandleEvent(Lpalmos/Event;)Z
M3:
	link	a6,#0
...
M3__stackOK
	...
	ext.l	d0
	move.l	d0,-(a7)
	bsr	M92	; (direct)Method palmos/Palm.FrmInitForm(I)I
	addq.l	#4,a7
	move.l	d0,d7
	move.l	d7,-(a7)
	bsr	M93	; (direct)Method palmos/Palm.FrmSetActiveForm(I)V
	move.l	d7,(a7)
	move.l	d7,-(a7)
	pea	1011
	bsr	M88	; (direct)Method palmos/Palm.FrmGetObjectIndex(II)I
	addq.l	#8,a7
	move.l	d0,-(a7)
	bsr	M89	; (direct)Method palmos/Palm.FrmGetObjectPtr(II)I
	addq.l	#8,a7
	move.l	12(a6),a0
	move.l	d0,(a0)
	move.l	#1,d0
...
M3__38:
	...
	bsr	M87	; (direct)Method palmos/Palm.FrmGetActiveForm()I
	move.l	d0,-(a7)
	bsr	M86	; (direct)Method palmos/Palm.FrmDrawForm(I)V
	move.l	#1,d0
	move.l	-8(a6),d7
	unlk	a6
	rts
M3__55:
	...
	move.l	12(a6),a0
	move.l	(a0),-(a7)
	bsr	M83	; (direct)Method palmos/Palm.FldDirty(I)Z
	addq.l	#4,a7
	tst.l	d0
	beq	M3__110
	move.l	12(a6),a0
	move.l	(a0),-(a7)
	bsr	M84	; (direct)Method palmos/Palm.FldGetTextPtr(I)Ljava/lang/String;
	addq.l	#4,a7
	...
	move.l	8(a7),a0
	bsr     nonnull_check
	bsr	M48	; (direct)Method MorseProducer.startProduction(Ljava/lang/String;I)V
	lea	12(a7),a7
M3__110:
	move.l	#1,d0
	move.l	-8(a6),d7
...
M4__stackOK
	...
	move.l	12(a7),a0
	bsr     nonnull_check
	bsr	M70	; (direct)Method palmos/SndCommand.setParams(III)V
	lea	16(a7),a7
	clr.l	-(a7)
	move.l	12(a6),a0
	move.l	8(a0),-(a7)
	clr.l	-(a7)
	bsr	M98	; (direct)Method palmos/Palm.SndDoCmd(Ljava/lang/Object;Lpalmos/SndCommand;Z)I
	unlk	a6
	rts
M4__exceptions:
	move.l	4(a6),d2
...
M15__stackOK
	move.l	8(a6),-(a7)
	bsr	M7	; (direct)Method java/lang/Object.getClass()Ljava/lang/Class;
	move.l	a0,(a7)
	move.l	(a7),a0
	bsr     nonnull_check
	bsr	M22	; (direct)Method java/lang/Class.getName()Ljava/lang/String;
	addq.l	#4,a7
	move.l	a0,d7	; direct from A0
	move.l	8(a6),a0
	tst.l	(a0)
...
M15__17:
	...
	bsr     op_new
	move.l	(a7),-(a7)
	bsr	M32	; (direct)Method java/lang/StringBuffer.<init>()V
	move.l	d7,(a7)
	bsr	M37	; (direct)Method java/lang/StringBuffer.append(Ljava/lang/String;)Ljava/lang/StringBuffer;
	addq.l	#8,a7
	move.l	a0,-(a7)
	pea	CS0(a5)	; ": "
	move.l	4(a7),a0
	...
	move.l	(a7),a0
	bsr     nonnull_check
	bsr	M43	; (direct)Method java/lang/StringBuffer.toString()Ljava/lang/String;
	move.l	-8(a6),d7
	unlk	a6
	rts
M15__exceptions:
...
M16__stackOK
	...
	beq	M16__11
	move.l	8(a6),-(a7)
	bsr	M18	; (direct)Method java/lang/Throwable.getMethodName(I)Ljava/lang/String;
	move.l	a0,(a7)
	bsr	M115	; (direct)Method palmos/JumpLog.println(Ljava/lang/String;)V
	addq.l	#4,a7
M16__11:
	unlk	a6
	rts
...
M17__stackOK
	...
	move.l	a0,-(a7)
	move.l	d7,-(a7)
	bsr	M15	; (direct)Method java/lang/Throwable.toString()Ljava/lang/String;
	move.l	a0,(a7)
	move.l	4(a7),a0
	bsr     nonnull_check
	bsr	M37	; (direct)Method java/lang/StringBuffer.append(Ljava/lang/String;)Ljava/lang/StringBuffer;
	...
	move.l	d7,a0
	move.l	4(a0),-(a7)
	bsr	M16	; (direct)Method java/lang/Throwable.printMethod(I)V
	addq.l	#4,a7
	move.l	d7,a0
	move.l	8(a0),-(a7)
	bsr	M16	; (direct)Method java/lang/Throwable.printMethod(I)V
...
M20__stackOK
	move.l	12(a6),-(a7)
	move.l	8(a6),-(a7)
	bsr	M14	; (direct)Method java/lang/Throwable.<init>(Ljava/lang/String;)V
	unlk	a6
	rts
M20__exceptions:
	move.l	4(a6),d2
...
M27__stackOK
	...
	move.l	(a7),-(a7)
	move.l	8(a6),-(a7)
	bsr	M24	; (direct)Method java/lang/Class.isInterface()Z
	addq.l	#4,a7
	tst.l	d0
	beq	M27__16
...
M27__16:
	move.l	8(a6),-(a7)
	bsr	M25	; (direct)Method java/lang/Class.isPrimitive()Z
	addq.l	#4,a7
	tst.l	d0
	beq	M27__28
	pea	CS4(a5)	; ""
...
M27__28:
	pea	CS5(a5)	; "class "
M27__30:
	bsr	M60	; (direct)Method java/lang/String.valueOf(Ljava/lang/Object;)Ljava/lang/String;
	move.l	a0,(a7)
	bsr	M34	; (direct)Method java/lang/StringBuffer.<init>(Ljava/lang/String;)V
	addq.l	#8,a7
	move.l	8(a6),-(a7)
	bsr	M22	; (direct)Method java/lang/Class.getName()Ljava/lang/String;
	move.l	a0,(a7)
...
M28__stackOK
	...
	move.l	8(a6),-(a7)
	bsr     op_idiv
	bsr	M33	; (direct)Method java/lang/StringBuffer.<init>(I)V
	addq.l	#8,a7
	move.l	(a7)+,d7
M28__12:
	move.l	d7,-(a7)
	...
	move.b	(a1),d0
	move.l	d0,-(a7)
	bsr	M35	; (direct)Method java/lang/StringBuffer.append(C)Ljava/lang/StringBuffer;
	addq.l	#8,a7
	move.l	a0,d0
	move.l	d6,d0
	move.l	8(a6),d1
	...
	bne	M28__12
	move.l	d7,-(a7)
	bsr	M42	; (direct)Method java/lang/StringBuffer.reverse()Ljava/lang/StringBuffer;
	move.l	a0,(a7)
	move.l	(a7),a0
	bsr     nonnull_check
	bsr	M43	; (direct)Method java/lang/StringBuffer.toString()Ljava/lang/String;
...
M35__stackOK
	...
	move.l	d7,-(a7)
	move.l	d6,-(a7)
	bsr	M39	; (direct)Method java/lang/StringBuffer.expandCapacity(I)V
	addq.l	#8,a7
M35__21:
	move.l	d7,a0
	move.l	(a0),-(a7)
...
M36__stackOK
	move.l	12(a6),-(a7)
	move.l	8(a6),-(a7)
	bsr	M61	; (direct)Method java/lang/String.valueOf(I)Ljava/lang/String;
	move.l	a0,(a7)
	bsr	M37	; (direct)Method java/lang/StringBuffer.append(Ljava/lang/String;)Ljava/lang/StringBuffer;
	unlk	a6
	rts
...
M37__35:
	...
	move.l	(a0),-(a7)
	move.l	4(a0),-(a7)
	bsr	M58	; (direct)Method java/lang/String.getChars(II[CI)V
	move.l	d7,a0
	move.l	d6,4(a0)
	movem.l	-20(a6),d7-d4
	unlk	a6
...
M38__stackOK
	...
	clr.l	-(a7)
	move.l	4(a0),-(a7)
	bsr	M111	; (direct)Method java/lang/System.arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
	lea	20(a7),a7
	move.l	d6,d0
	move.l	d7,a0
	move.l	d0,(a0)
...
M40__stackOK
	...
	blt	M40__21
M40__12:
	move.l	#34,d0	; Class java/lang/StringIndexOutOfBoundsException
	bsr     op_new
	move.l	(a7),-(a7)
	move.l	d7,-(a7)
	bsr	M108	; (direct)Method java/lang/StringIndexOutOfBoundsException.<init>(I)V
	addq.l	#8,a7
	bsr     op_athrow
M40__21:
	tst.l	d6
...
M40__64:
	...
	bsr	M109	; (direct)Method java/lang/StringIndexOutOfBoundsException.<init>(Ljava/lang/String;)V
	addq.l	#8,a7
	bsr     op_athrow
M40__79:
	movem.l	-12(a6),d7-d6
...
M42__stackOK
	...
	beq	M42__11
	move.l	a0,-(a7)
	bsr	M38	; (direct)Method java/lang/StringBuffer.copy()V
	addq.l	#4,a7
M42__11:
	move.l	d6,a0
	move.l	4(a0),d0
...
M43__stackOK
	...
	move.l	(a7),-(a7)
	move.l	8(a6),-(a7)
	bsr	M53	; (direct)Method java/lang/String.<init>(Ljava/lang/StringBuffer;)V
	addq.l	#8,a7
	move.l	(a7)+,a0
	unlk	a6
	rts
...
M46__stackOK
	move.l	12(a6),-(a7)
	move.l	8(a6),-(a7)
	bsr	M20	; (direct)Method java/lang/Exception.<init>(Ljava/lang/String;)V
	unlk	a6
	rts
M46__exceptions:
	move.l	4(a6),d2
...
M47__exceptions:
	...
	move.l	-4(a6),a1
	jmp	(a1)	; previous exception handler
; Method MorseProducer.startProduction(Ljava/lang/String;I)V
M48:
	link	a6,#0
	pea	M48__exceptions(pc)
	move.l	d7,-(a7)
	move.l	16(a6),d7	; arg 0
	cmp.l	StackLimit(a5),a7
	bcc.s	M48__stackOK
	bsr     throw_StackOverflowError
M48__stackOK
	...
	move.l	4(a7),a0
	bsr     nonnull_check
	bsr	M57	; (direct)Method java/lang/String.charAt(I)C
	addq.l	#8,a7
	move.l	d0,-(a7)
	bsr	M52	; (direct)Method MorseProducer.convert(C)Ljava/lang/String;
	addq.l	#8,a7
	move.l	a0,d0
	move.l	d7,a0
	move.l	d0,8(a0)
...
M48__exceptions:
	...
	move.l	-4(a6),a1
	jmp	(a1)	; previous exception handler
; Method MorseProducer.isRunning()Z
M49:
	link	a6,#0
...
M49__exceptions:
	...
	move.l	-4(a6),a1
	jmp	(a1)	; previous exception handler
; Method MorseProducer.getNextTick()I
M50:
	link	a6,#0
...
M50__exceptions:
	...
	move.l	-4(a6),a1
	jmp	(a1)	; previous exception handler
; Method MorseProducer.playNow(I)I
M51:
	link	a6,#0
...
M51__exceptions:
	...
	move.l	-4(a6),a1
	jmp	(a1)	; previous exception handler
; Method MorseProducer.convert(C)Ljava/lang/String;
M52:
	link	a6,#0
...
M53__stackOK
	...
	move.l	(a0),-(a7)
	clr.l	-(a7)
	bsr	M40	; (direct)Method java/lang/StringBuffer.getChars(II[CI)V
	lea	20(a7),a7
M53__43:
	move.l	-8(a6),d7
	unlk	a6
...
M62:
	link	a6,#0
	pea	M62__exceptions(pc)
	cmp.l	StackLimit(a5),a7
	bcc.s	M62__stackOK
	bsr     throw_StackOverflowError
M62__stackOK
	pea	CS55(a5)	; "float"
	bsr	M23	; (direct)Method java/lang/Class.getPrimitiveClass(Ljava/lang/String;)Ljava/lang/Class;
	addq.l	#4,a7
	move.l	a0,d0
	unlk	a6
	rts
...
M67__stackOK
	move.l	12(a6),-(a7)
	move.l	8(a6),-(a7)
	bsr	M46	; (direct)Method java/lang/RuntimeException.<init>(Ljava/lang/String;)V
	unlk	a6
	rts
M67__exceptions:
	move.l	4(a6),d2
	...
	move.l	-4(a6),a1
	jmp	(a1)	; previous exception handler
; Method palmos/SndCommand.setParams(III)V
M70:
	link	a6,#0
	pea	M70__exceptions(pc)
	move.l	d7,-(a7)
	move.l	20(a6),d7	; arg 0
	cmp.l	StackLimit(a5),a7
	bcc.s	M70__stackOK
	bsr     throw_StackOverflowError
M70__stackOK
...
M108__stackOK
	...
	bsr     op_new
	move.l	(a7),-(a7)
	pea	CS57(a5)	; "String index out of range: "
	bsr	M34	; (direct)Method java/lang/StringBuffer.<init>(Ljava/lang/String;)V
	addq.l	#8,a7
	move.l	8(a6),-(a7)
	bsr	M36	; (direct)Method java/lang/StringBuffer.append(I)Ljava/lang/StringBuffer;
	addq.l	#8,a7
	move.l	a0,-(a7)
	move.l	(a7),a0
	bsr     nonnull_check
	bsr	M43	; (direct)Method java/lang/StringBuffer.toString()Ljava/lang/String;
	move.l	a0,(a7)
	bsr	M67	; (direct)Method java/lang/IndexOutOfBoundsException.<init>(Ljava/lang/String;)V
	unlk	a6
	rts
M108__exceptions:
	move.l	4(a6),d2
...
M113__stackOK
	...
	move.l	16(a6),-(a7)
	move.l	d3,-(a7)
	bsr	M78	; (direct)Method palmos/Palm.DmQueryRecord(II)I
	addq.l	#8,a7
	move.l	d0,d7
	; avoided 	tst.l	d7
	beq	M113__183
	move.l	d7,-(a7)
	bsr	M94	; (direct)Method palmos/Palm.MemHandleLock(I)I
	addq.l	#4,a7
	move.l	d0,d6
	move.l	d6,-(a7)
	bsr	M71	; (direct)Method palmos/Palm.nativeGetInt(I)I
	addq.l	#4,a7
	cmp.l	#1249209712,d0
	bne	M113__177
	move.l	d6,d0
	...
	add.l	#8,d0
	move.l	d0,-(a7)
	bsr	M72	; (direct)Method palmos/Palm.nativeGetByte(I)I
	addq.l	#4,a7
	cmp.l	#10,d0
	bne	M113__177
	move.l	d7,-(a7)
	bsr	M95	; (direct)Method palmos/Palm.MemHandleSize(I)I
	addq.l	#4,a7
	sub.l	#1,d0
	move.l	d0,d5
	move.b	SF2(a5),d0
...
M113__88:
	...
	move.l	d0,-28(a6)
	move.l	d7,-(a7)
	bsr	M96	; (direct)Method palmos/Palm.MemHandleUnlock(I)I
	move.l	16(a6),(a7)
	move.l	d3,-(a7)
	move.l	-28(a6),-(a7)
	bsr	M80	; (direct)Method palmos/Palm.DmResizeRecord(III)I
	lea	12(a7),a7
	move.l	d0,-32(a6)
	move.l	16(a6),-(a7)
	move.l	d3,-(a7)
	bsr	M74	; (direct)Method palmos/Palm.DmGetRecord(II)I
	addq.l	#8,a7
	move.l	d0,d7
	move.l	d7,-(a7)
	bsr	M94	; (direct)Method palmos/Palm.MemHandleLock(I)I
	...
	move.l	8(a6),-(a7)
	move.l	d4,-(a7)
	bsr	M81	; (direct)Method palmos/Palm.DmWrite(IILjava/lang/Object;I)I
	lea	16(a7),a7
	move.l	d6,-(a7)
	move.l	d5,d0
	add.l	d4,d0
	...
	move.l	d3,-(a7)
	pea	1
	bsr	M79	; (direct)Method palmos/Palm.DmReleaseRecord(IIZ)I
	lea	12(a7),a7
	move.l	-28(a6),d0
	sub.l	#1,d0
	move.l	d0,d5
...
M115__stackOK
	...
	pea	3
	bsr	M77	; (direct)Method palmos/Palm.DmOpenDatabaseByTypeCreator(III)I
	lea	12(a7),a7
	move.l	d0,d7
M115__19:
	tst.l	d7
	...
	move.l	SF0(a5),-(a7)
	move.l	d3,-(a7)
	bsr	M113	; (direct)Method palmos/JumpLog.writeRecord(IILjava/lang/String;)Z
	lea	12(a7),a7
	tst.l	d0
	bne	M115__132
	move.l	d7,-(a7)
	bsr	M76	; (direct)Method palmos/Palm.DmNumRecords(I)I
	addq.l	#4,a7
	move.l	d0,-28(a6)
	move.l	-28(a6),d6
M115__41:
...
M115__60:
	...
	bsr     op_new
	move.l	(a7),-(a7)
	bsr	M101	; (direct)Method palmos/ShortHolder.<init>()V
	addq.l	#4,a7
	move.l	(a7)+,d4
	move.l	d7,-(a7)
	move.l	d4,-(a7)
	pea	10
	bsr	M75	; (direct)Method palmos/Palm.DmNewRecord(ILpalmos/ShortHolder;I)I
	lea	12(a7),a7
	move.l	d0,d5
	; avoided 	tst.l	d5
	beq	M115__132
...
M115__132:
	...
	bne	M115__143
	move.l	d7,-(a7)
	bsr	M73	; (direct)Method palmos/Palm.DmCloseDatabase(I)I
	addq.l	#4,a7
M115__143:
	move.l	d3,-(a7)
	bsr	M114	; (direct)Method palmos/JumpLog.reporter(Ljava/lang/String;)V
	movem.l	-24(a6),d7-d3
	unlk	a6
	rts
M115__exceptions:
...
ClassTable:
	...
	dc.b	0,0
	dc.w	M0	; def constructor
	dc.w	class2__name
	dc.l	class2__vtable-0
	dc.w	0,0,0,0		; no itable index
	dc.b	$0	; %0
	dc.b	$0	; %0
	dc.w	1		; ObjectHeader_ClassIndex: java/lang/Class
	...
	dc.b	$0	; %0
	dc.w	1		; ObjectHeader_ClassIndex: java/lang/Class
	dc.w	16	; java/lang/RuntimeException
	dc.w	ObjectHeader_sizeof+36
	dc.b	0,0
	dc.w	M_none	; def constructor
	dc.w	class15__name
	dc.l	class15__vtable-0
	dc.w	0,0,0,0		; no itable index
	dc.b	$0	; %0
	dc.b	$0	; %0
	dc.w	1		; ObjectHeader_ClassIndex: java/lang/Class
	...
	dc.w	1		; ObjectHeader_ClassIndex: java/lang/Class
	dc.w	0	; java/lang/Object
	dc.w	ObjectHeader_sizeof+30
	dc.b	0,0
	dc.w	M47	; def constructor
	dc.w	class17__name
	dc.l	class17__vtable-0
	dc.w	0,0,0,0		; no itable index
	dc.b	$0	; %0
	dc.b	$0	; %0
	dc.w	1		; ObjectHeader_ClassIndex: java/lang/Class
	...
	dc.b	0,ClassInfo_arrayofobjects
	dc.w	M_none	; def constructor
	dc.w	class21__name
	dc.l	class21__vtable-0
	btst	#0,ClassInfo.Itable+0(a1)
	rts
	dc.b	$0	; %0
	dc.b	$0	; %0
	dc.w	1		; ObjectHeader_ClassIndex: java/lang/Class
	...
	dc.b	$0	; %0
	dc.w	1		; ObjectHeader_ClassIndex: java/lang/Class
	dc.w	25	; java/lang/IndexOutOfBoundsException
	dc.w	ObjectHeader_sizeof+36
	dc.b	0,0
	dc.w	M_none	; def constructor
	dc.w	class24__name
	dc.l	class24__vtable-0
	dc.w	0,0,0,0		; no itable index
	dc.b	$0	; %0
	dc.b	$0	; %0
	dc.w	1		; ObjectHeader_ClassIndex: java/lang/Class
...
class1__name	dc.b	'java.lang.Class',0
	align	2
class1__vtable:
	dc.w	M27	; Method java/lang/Class.toString()Ljava/lang/String;
class2__name	dc.b	'Morse',0
	align	2
class2__vtable:
	dc.w	M9	; Method java/lang/Object.toString()Ljava/lang/String;
class3__name	dc.b	'java.lang.OutOfMemoryError',0
	align	2
class3__vtable:
	dc.w	M15	; Method java/lang/Throwable.toString()Ljava/lang/String;
...
class14__name	dc.b	'java.lang.StringBuffer',0
	align	2
class14__vtable:
	dc.w	M43	; Method java/lang/StringBuffer.toString()Ljava/lang/String;
class15__name	dc.b	'java.lang.NullPointerException',0
	align	2
class15__vtable:
	dc.w	M15	; Method java/lang/Throwable.toString()Ljava/lang/String;
class16__name	dc.b	'java.lang.RuntimeException',0
	align	2
class17__name	dc.b	'MorseProducer',0
	align	2
class17__vtable:
	dc.w	M9	; Method java/lang/Object.toString()Ljava/lang/String;
class18__name	dc.b	'java.lang.String',0
	align	2
class18__vtable:
	dc.w	M55	; Method java/lang/String.toString()Ljava/lang/String;
class19__name	dc.b	'java.lang.Float',0
	align	2
class20__name	dc.b	'java.lang.Double',0
	align	2
class21__name	dc.b	'[Ljava.lang.String;',0
	align	2
class21__vtable:
	dc.w	M9	; Method java/lang/Object.toString()Ljava/lang/String;
class22__name	dc.b	'-S-',0
	align	2
class23__name	dc.b	'java.lang.NegativeArraySizeException',0
	align	2
class23__vtable:
	dc.w	M15	; Method java/lang/Throwable.toString()Ljava/lang/String;
class24__name	dc.b	'java.lang.ArrayIndexOutOfBoundsException',0
	align	2
class24__vtable:
	dc.w	M15	; Method java/lang/Throwable.toString()Ljava/lang/String;
class25__name	dc.b	'java.lang.IndexOutOfBoundsException',0
	align	2
class26__name	dc.b	'java.lang.ArrayStoreException',0
	align	2
class26__vtable:
	dc.w	M15	; Method java/lang/Throwable.toString()Ljava/lang/String;
class27__name	dc.b	'palmos.SndCommand',0
	align	2
class27__vtable:
	dc.w	M9	; Method java/lang/Object.toString()Ljava/lang/String;
class28__name	dc.b	'palmos.Palm',0
	align	2
class29__name	dc.b	'palmos.ShortHolder',0
	align	2
class29__vtable:
	dc.w	M9	; Method java/lang/Object.toString()Ljava/lang/String;
class30__name	dc.b	'palmos.Event',0
	align	2
class30__vtable:
	dc.w	M9	; Method java/lang/Object.toString()Ljava/lang/String;
class31__name	dc.b	'-B-',0
	align	2
class32__name	dc.b	'-Z-',0
	align	2
class33__name	dc.b	'java.lang.ArithmeticException',0
	align	2
class33__vtable:
	dc.w	M15	; Method java/lang/Throwable.toString()Ljava/lang/String;
class34__name	dc.b	'java.lang.StringIndexOutOfBoundsException',0
	align	2
class34__vtable:
	dc.w	M15	; Method java/lang/Throwable.toString()Ljava/lang/String;
class35__name	dc.b	'[C',0
	align	2
class35__vtable:
	dc.w	M9	; Method java/lang/Object.toString()Ljava/lang/String;
class36__name	dc.b	'java.lang.System',0
	align	2
class37__name	dc.b	'palmos.JumpLog',0
	align	2
class38__name	dc.b	'java.lang.ClassCastException',0
	align	2
class38__vtable:
	dc.w	M15	; Method java/lang/Throwable.toString()Ljava/lang/String;
class39__name	dc.b	'java.lang.StackOverflowError',0
	align	2
class39__vtable:
	dc.w	M15	; Method java/lang/Throwable.toString()Ljava/lang/String;
	code
...
cstring_block
	...
	dc.b	$78, 0
	dc.b	$20, 0
	dc.b	$2e,$2d,$2e,$2e,$2d,$2e, 0
	dc.b	$2e,$2d,$2d,$2d,$2d,$2e, 0
	dc.b	$2d,$2e,$2d,$2d,$2e,$2d, 0
	dc.b	$2d,$2d,$2e,$2e,$2d,$2d, 0
	dc.b	$2d,$2e,$2e,$2e,$2e,$2d, 0
	dc.b	$2e,$2d,$2e,$2d,$2e,$2d, 0
	dc.b	$2d,$2e,$2e,$2d,$2e, 0
	dc.b	$2d,$2d,$2d,$2d,$2d, 0
	dc.b	$2e,$2d,$2d,$2d,$2d, 0
	dc.b	$2e,$2e,$2d,$2d,$2d, 0
	dc.b	$2e,$2e,$2e,$2d,$2d, 0
	dc.b	$2e,$2e,$2e,$2e,$2d, 0
	dc.b	$2e,$2e,$2e,$2e,$2e, 0
	dc.b	$2d,$2e,$2e,$2e,$2e, 0
	dc.b	$2d,$2d,$2e,$2e,$2e, 0
	dc.b	$2d,$2d,$2d,$2e,$2e, 0
	dc.b	$2d,$2d,$2d,$2d,$2e, 0
	dc.b	$2d,$2d,$2d,$2e,$2e,$2e, 0
	dc.b	$2e,$2e,$2d,$2d,$2e,$2e, 0
	dc.b	$2e,$2d, 0
	dc.b	$2d,$2e,$2e,$2e, 0
	dc.b	$2d,$2e,$2d,$2e, 0
	dc.b	$2d,$2e,$2e, 0
...
CS8_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	1	; 'count' String length
	dc.l	93	; 'offset' within cstring_array
	dc.w	18
CS9:
CS9_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	6	; 'count' String length
	dc.l	95	; 'offset' within cstring_array
	dc.w	18
CS10:
CS10_value:
	dc.l	0	; 'value' points to cstring_array
...
CS12_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	6	; 'count' String length
	dc.l	116	; 'offset' within cstring_array
	dc.w	18
CS13:
CS13_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	6	; 'count' String length
	dc.l	123	; 'offset' within cstring_array
	dc.w	18
CS14:
CS14_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	6	; 'count' String length
	dc.l	130	; 'offset' within cstring_array
	dc.w	18
CS15:
CS15_value:
	dc.l	0	; 'value' points to cstring_array
...
CS16_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	5	; 'count' String length
	dc.l	143	; 'offset' within cstring_array
	dc.w	18
CS17:
CS17_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	5	; 'count' String length
	dc.l	149	; 'offset' within cstring_array
	dc.w	18
CS18:
CS18_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	5	; 'count' String length
	dc.l	155	; 'offset' within cstring_array
	dc.w	18
CS19:
CS19_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	5	; 'count' String length
	dc.l	161	; 'offset' within cstring_array
	dc.w	18
CS20:
CS20_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	5	; 'count' String length
	dc.l	167	; 'offset' within cstring_array
	dc.w	18
CS21:
CS21_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	5	; 'count' String length
	dc.l	173	; 'offset' within cstring_array
	dc.w	18
CS22:
CS22_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	5	; 'count' String length
	dc.l	179	; 'offset' within cstring_array
	dc.w	18
CS23:
CS23_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	5	; 'count' String length
	dc.l	185	; 'offset' within cstring_array
	dc.w	18
CS24:
CS24_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	5	; 'count' String length
	dc.l	191	; 'offset' within cstring_array
	dc.w	18
CS25:
CS25_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	5	; 'count' String length
	dc.l	197	; 'offset' within cstring_array
	dc.w	18
CS26:
CS26_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	6	; 'count' String length
	dc.l	203	; 'offset' within cstring_array
	dc.w	18
CS27:
CS27_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	6	; 'count' String length
	dc.l	210	; 'offset' within cstring_array
	dc.w	18
CS28:
CS28_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	2	; 'count' String length
	dc.l	217	; 'offset' within cstring_array
	dc.w	18
CS29:
CS29_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	4	; 'count' String length
	dc.l	220	; 'offset' within cstring_array
	dc.w	18
CS30:
CS30_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	4	; 'count' String length
	dc.l	225	; 'offset' within cstring_array
	dc.w	18
CS31:
CS31_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	3	; 'count' String length
	dc.l	230	; 'offset' within cstring_array
	dc.w	18
CS32:
CS32_value:
	dc.l	0	; 'value' points to cstring_array
...
CS33_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	4	; 'count' String length
	dc.l	236	; 'offset' within cstring_array
	dc.w	18
CS34:
CS34_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	3	; 'count' String length
	dc.l	241	; 'offset' within cstring_array
	dc.w	18
CS35:
CS35_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	4	; 'count' String length
	dc.l	245	; 'offset' within cstring_array
	dc.w	18
CS36:
CS36_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	2	; 'count' String length
	dc.l	250	; 'offset' within cstring_array
	dc.w	18
CS37:
CS37_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	4	; 'count' String length
	dc.l	253	; 'offset' within cstring_array
	dc.w	18
CS38:
CS38_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	3	; 'count' String length
	dc.l	258	; 'offset' within cstring_array
	dc.w	18
CS39:
CS39_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	4	; 'count' String length
	dc.l	262	; 'offset' within cstring_array
	dc.w	18
CS40:
CS40_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	2	; 'count' String length
	dc.l	267	; 'offset' within cstring_array
	dc.w	18
CS41:
CS41_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	2	; 'count' String length
	dc.l	270	; 'offset' within cstring_array
	dc.w	18
CS42:
CS42_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	3	; 'count' String length
	dc.l	273	; 'offset' within cstring_array
	dc.w	18
CS43:
CS43_value:
	dc.l	0	; 'value' points to cstring_array
...
CS44_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	4	; 'count' String length
	dc.l	282	; 'offset' within cstring_array
	dc.w	18
CS45:
CS45_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	3	; 'count' String length
	dc.l	287	; 'offset' within cstring_array
	dc.w	18
CS46:
CS46_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	3	; 'count' String length
	dc.l	291	; 'offset' within cstring_array
	dc.w	18
CS47:
CS47_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	1	; 'count' String length
	dc.l	295	; 'offset' within cstring_array
	dc.w	18
CS48:
CS48_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	3	; 'count' String length
	dc.l	297	; 'offset' within cstring_array
	dc.w	18
CS49:
CS49_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	4	; 'count' String length
	dc.l	301	; 'offset' within cstring_array
	dc.w	18
CS50:
CS50_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	3	; 'count' String length
	dc.l	306	; 'offset' within cstring_array
	dc.w	18
CS51:
CS51_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	4	; 'count' String length
	dc.l	310	; 'offset' within cstring_array
	dc.w	18
CS52:
CS52_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	4	; 'count' String length
	dc.l	315	; 'offset' within cstring_array
	dc.w	18
CS53:
CS53_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	4	; 'count' String length
	dc.l	320	; 'offset' within cstring_array
	dc.w	18
CS54:
CS54_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	4	; 'count' String length
	dc.l	325	; 'offset' within cstring_array
	dc.w	18
CS55:
CS55_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	5	; 'count' String length
	dc.l	330	; 'offset' within cstring_array
	dc.w	18
CS56:
CS56_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	6	; 'count' String length
	dc.l	336	; 'offset' within cstring_array
	dc.w	18
CS57:
CS57_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	27	; 'count' String length
	dc.l	343	; 'offset' within cstring_array
	dc.w	18
CS58:
CS58_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	1	; 'count' String length
	dc.l	371	; 'offset' within cstring_array
	dc.w	18
CS59:
CS59_value:
	dc.l	0	; 'value' points to cstring_array
	dc.l	9	; 'count' String length
	dc.l	373	; 'offset' within cstring_array
CS_NUM	equ	60
